...
class LongTasksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create long_task" do
    assert_difference('LongTask.count') do
      post long_tasks_url, params: { long_task: { description: @long_task.description, list_id: @long_task.list_id, priority: @long_task.priority, progress: @long_task.progress, state: @long_task.state, type: @long_task.type } }
    end
  ...
  test "should update long_task" do
    patch long_task_url(@long_task), params: { long_task: { description: @long_task.description, list_id: @long_task.list_id, priority: @long_task.priority, progress: @long_task.progress, state: @long_task.state, type: @long_task.type } }
